...
function IconClock({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
...
export default function TempleView() {
  ...
  // FIX: compute prohibited items string safely so .join is never called on undefined
          ...
          <Section id="nearby" title="Nearby Places">
            <div className="space-y-3">
              {temple.nearbyPlaces.map((p, i) => (
                <div key={i} className="p-3 bg-orange-50 rounded-xl border hover:bg-orange-100 transition">
