...
// 👇 Add this helper before your component
...
interface Donation {
  ...
  price: number; // base price (you may change)
}
...
export default function DonationView() {
  ...
  // preset amounts: you said suggestion of 4 amounts
  const presets = [donation.price, donation.price * 2, donation.price * 3, donation.price * 5];
  ...
  if (!amount || Number(amount) < 1) return setError("Please enter a valid amount (minimum ₹1)");
...
window.location.href = "/donors";
    ...
    console.error("Error in donation payment:", err);
    ...
    <div className="pt-24 pb-20 px-6 md:px-20 bg-gray-50 min-h-screen">
      <div className="flex flex-col md:flex-row gap-10 items-start">
        ...
        <div className="md:w-1/2">
          <img
            src={donation.thumbnail || "/placeholder.jpg"}
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">{t(donation.templeDetails)}</p>
          <h3 className="text-xl font-semibold text-orange-700 mb-1">About Donation</h3>
          <p className="text-gray-700 mb-3">{t(donation.description)}</p>
          <h3 className="text-xl font-semibold text-orange-700 mb-1">Benefits</h3>
          <p className="text-gray-700 mb-3">{t(donation.benefits)}</p>

          {/* donation form */}
          <div className="mt-8 bg-white rounded-xl shadow p-6">
            <h3 className="text-xl font-semibold text-orange-700 mb-4">Make a Donation</h3>
            ...
            <div className="mb-4">
              <label className="block font-medium mb-1">Mobile / WhatsApp Number</label>
              <input
                type="text"
                value={mobile}
      ...
      <button
        ...
        className={`px-4 py-2 rounded-lg border font-semibold transition ${
          amount === p
            ...
            : "bg-white text-gray-800 hover:bg-orange-50 border-gray-300"
        }`}
      >
        ₹{p}
      </button>
