...
export default function Hero() {
  ...
  return (
    <div className="relative w-full overflow-hidden 
        h-[70vh] md:h-[90vh]   /* PC height unchanged */
        mt-0 p-0">             {/* MOBILE: NO margin/padding */}
      
      {slides.map((s, i) => (
        <div
          key={i}
          className={`absolute inset-0 transition-opacity duration-700 
          ${i === current ? "opacity-100 z-20" : "opacity-0 z-0"}`}
        >
          {/* BACKGROUND + IMAGE */}
          <div className="w-full h-full flex items-center justify-center bg-black">
            <img
              ...
              className="
                ...
                object-contain               /* FULL IMAGE ALWAYS */
              "
            />
          </div>
          ...
          >
            ...
            <p
              ...
              text-gray-200 leading-relaxed drop-shadow-xl"
